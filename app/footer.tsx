export default function Footer() {
    return (
        <>
            ...
            <p className="mb-4">Updated to <a className="underline" href="https://marginalrevolution.com/marginalrevolution/2026/06/emergent-ventures-winners-55th-cohort.html">Cohort 55</a>, as of June 24, 2026. Submit a data update to the <a className="underline" href="https://github.com/nqureshi/ev-search-python/tree/main/data">Github repo</a>.</p>
        </>
    )
}
