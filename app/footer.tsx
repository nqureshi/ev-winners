export default function Footer() {
    return (
        <>
            ...
            <p className="mb-4">Updated to cohort 49, as of November 23, 2025. Submit a data update to the <a className="underline" href="https://github.com/nqureshi/ev-search-python/tree/main/data">Github repo</a>.</p>
        </>
    )
}
