export default function Footer() {
    return (
        <>
            ...
            <p className="mb-4">Updated to <a className="underline" href="https://marginalrevolution.com/marginalrevolution/2026/05/emergent-ventures-winners-54th-cohort.html">Cohort 54</a>, as of May 25, 2026. Submit a data update to the <a className="underline" href="https://github.com/nqureshi/ev-search-python/tree/main/data">Github repo</a>.</p>
        </>
    )
}
